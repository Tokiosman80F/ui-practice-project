...
const Hero = () => {
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <DotPattern>
        <div className="z-20s relative my-40 flex w-full flex-col items-center justify-center">
          ...
          <div className="mt-12 flex w-full max-w-2xl justify-center gap-2">
            ...
            />
            <button className="group relative cursor-pointer overflow-hidden rounded-full border border-neutral-700 px-4 py-2 text-neutral-300 transition-all duration-500 ease-in-out hover:border-bs-sky-500/50 hover:text-white hover:shadow-[0_0_25px_rgba(14,165,233,0.35)]">
